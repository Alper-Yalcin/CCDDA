...
const C = {
  en: {
    badge: 'B.Sc. Thesis Research Output — 2026',
    tubitakBadge: 'TÜBİTAK-Approved Undergraduate Research Project',
    heroTitleA: 'We Read Emotions from ',
    heroTitleB: "Children's Drawings.",
    heroLead:
      'A prototype trained on the KIDO dataset with a ResNet-50-based Concept Bottleneck architecture; it reaches the emotion not directly from pixels but through 16 figure-aware clinical indicators, offering decision support with Grad-CAM and LLM-assisted clinical explanations.',
    tubitakTitle: 'TÜBİTAK-approved undergraduate thesis project',
    tubitakBody:
      'Developed within a B.Sc. graduation thesis, the work carries the TÜBİTAK-approved project status as its primary project identity through its academic research and prototype outputs.',
    startAnalysis: 'Start Analysis',
    exploreSystem: 'Explore the System',
    approachEyebrow: 'OUR SYSTEM APPROACH',
    approachTitle: 'Scientific. Explainable. Trustworthy.',
    howEyebrow: 'How does it work?',
    howTitle: 'From drawing to an explainable report.',
    archEyebrow: 'System Architecture',
    archTitle: 'Concept bottleneck decision flow.',
    archBody:
      'Clinical indicators are extracted before the emotion; the emotion class is determined not directly from pixels but from this explainable intermediate representation.',
    techEyebrow: 'Technology & Approach',
    techTitle: 'Interpretable by design.',
    ethicsTitle: 'Usage boundary',
    ethicsBody:
      'This system is not a clinical diagnosis tool. It is an explainable decision-support prototype designed to assist expert judgment; all outputs must be interpreted by a qualified professional.',
    aboutBtn: 'About the Project',
  },
  tr: {
    badge: 'Lisans Tezi Araştırma Çıktısı — 2026',
    tubitakBadge: 'TÜBİTAK Onaylı Lisans Araştırma Projesi',
    heroTitleA: 'Çocuk Çizimlerinden Duyguları ',
    heroTitleB: 'Anlıyoruz.',
    heroLead:
    ...
    tubitakTitle: 'TÜBİTAK onaylı lisans tez projesi',
    tubitakBody:
    ...
    approachEyebrow: 'SİSTEM YAKLAŞIMIMIZ',
    approachTitle: 'Bilimsel. Açıklanabilir. Güvenilir.',
    howEyebrow: 'Nasıl Çalışır?',
    howTitle: 'Çizimden açıklanabilir rapora uzanan süreç.',
    archEyebrow: 'Sistem Mimarisi',
    archTitle: 'Kavram darboğazı karar akışı.',
    archBody:
    ...
    techEyebrow: 'Teknoloji & Yaklaşım',
    techTitle: 'Tasarım gereği yorumlanabilir.',
    ethicsTitle: 'Kullanım Sınırı',
    ethicsBody:
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="overflow-hidden">
        ...
        <div className="relative mx-auto grid w-full max-w-[1520px] min-w-0 grid-cols-1 items-center gap-10 px-4 py-12 sm:px-6 lg:min-h-[760px] lg:grid-cols-[0.92fr_1.08fr] lg:py-14">
          ...
          >
            ...
            <h1 className="max-w-4xl break-words font-serif text-5xl font-semibold leading-[1.02] tracking-[-0.025em] text-ink sm:text-6xl lg:text-7xl xl:text-[86px]">
              {c.heroTitleA}<span className="block text-[#E76F3C] sm:inline">{c.heroTitleB}</span>
            </h1>
            ...
            <div className="mt-7 flex max-w-2xl gap-4 border-y border-line bg-surface/45 py-4">
              ...
              <div>
                <div className="font-semibold text-ink">{c.tubitakTitle}</div>
      ...
      <main className="mx-auto max-w-[1520px] px-4 sm:px-6">
        <section className="py-16 text-center sm:py-20">
          <div className="text-xs font-bold uppercase tracking-[0.42em] text-[#E76F3C]">{c.approachEyebrow}</div>
        ...
        <section className="border-y border-line py-16 sm:py-20">
          <div className="grid gap-10 lg:grid-cols-[0.35fr_1fr]">
            <div>
              <div className="text-xs font-bold uppercase tracking-[0.28em] text-[#E76F3C]">{c.howEyebrow}</div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="lg:mt-6">
                        <h3 className="font-serif text-2xl font-semibold leading-tight text-ink">{step.title[lang]}</h3>
                        <p className="mt-3 text-sm leading-7 text-muted">{step.body[lang]}</p>
                      </div>
                    </motion.div>
                  );
                })}
        ...
        <section className="py-16 sm:py-20">
          <div className="grid gap-10 lg:grid-cols-[0.35fr_1fr]">
            <div>
              <div className="text-xs font-bold uppercase tracking-[0.28em] text-[#E76F3C]">{c.archEyebrow}</div>
              <h2 className="mt-4 font-serif text-4xl font-semibold leading-tight tracking-[-0.02em] text-ink">
                {c.archTitle}
              </h2>
        ...
        <section className="border-t border-line py-16 sm:py-20">
          <div className="grid gap-10 lg:grid-cols-[0.35fr_1fr]">
            <div>
              <div className="text-xs font-bold uppercase tracking-[0.28em] text-[#E76F3C]">{c.techEyebrow}</div>
              <h2 className="mt-4 font-serif text-4xl font-semibold leading-tight tracking-[-0.02em] text-ink">
                {c.techTitle}
              </h2>
            </div>
            <div className="grid border-t border-line md:grid-cols-2">
              {technologyHighlights.map((item) => {
                ...
                return (
                  <div key={item.title.en} className="flex gap-4 border-b border-line py-6 md:odd:pr-7 md:even:border-l md:even:pl-7">
                    <div className="mt-1 grid h-11 w-11 shrink-0 place-items-center rounded-full bg-tint text-[#E76F3C]">
                      <Icon size={20} strokeWidth={1.75} />
                    </div>
                    <div>
                      <h3 className="font-semibold leading-snug text-ink">{item.title[lang]}</h3>
        ...
        <section className="mb-20 border-y border-line bg-tint/48 py-7">
          <div className="flex flex-col gap-6 px-1 md:flex-row md:items-center md:justify-between">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-serif text-2xl font-semibold text-ink">{c.ethicsTitle}</div>
        ...
        {homeStats.map((stat) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <div className="font-serif text-3xl font-semibold leading-none text-[#FFF6EA]">{stat.value[lang]}</div>
                <div className="mt-2 text-sm leading-5 text-white/72">{stat.label[lang]}</div>
              </div>
            </motion.div>
          );
        })}
